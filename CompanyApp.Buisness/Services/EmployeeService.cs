...
namespace CompanyApp.Buisness.Services
{
    public class EmployeeService : IEmployee
    {
            ...
            public Employee Create(Employee employee, string departmentName)
        {
            ...
            employee.Id = Count;
            //employee.Departament = ExistDepartment;
        ...
        {
            return _employeeRepositories.GetAll(s=>s.Name == name);
        }

        public List<Employee> GetAll(int age)
        {
            return _employeeRepositories.GetAll(s => s.Age==age);
        }

        public List<Employee> GetAll(byte departmentId)
        {
            return _employeeRepositories.GetAll(s => s.Equals(departmentId));
        }
